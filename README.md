...
![Word template](docs/demo-template-docx.png)

<!-- Request and response in Postman / Thunder Client -->
![Postman request](docs/demo-postman.png)

<!-- Word document generated by the system -->
![Generated Word document](docs/demo-output-docx.png)

<!-- PDF generated by LibreOffice -->
![Generated PDF](docs/demo-output-pdf.png)
